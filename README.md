...
This branch introduces significant security enhancements to the communication protocol, primarily focusing on protecting against Message Tampering and ensuring bidirectional encrypted data exchange.
