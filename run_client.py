...
def compile_client():
    ...
    if system == "Linux":
        ...
        compile_cmd = f"g++ src/client/client.cc src/client/socket_client.cc src/encryption/data_encryp.cc src/utils/convert_data.cc src/encryption/data_encryp.cc src/utils/convert_data.cc -Iasio/include -Iinclude -D_WIN32_WINNT=0x0601 -o {binary} -lsodium -lws2_32 -lmswsock"
    elif system == "Darwin":  # macOS
